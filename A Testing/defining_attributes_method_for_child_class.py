...
class ElectricCar(Car):	
	...
	def __init__(self, make, model, year):
		...
		Then initialize attributes for the electic car.
		"""
		...
		self.battery_size = 70  # Child class atribute with a default value.
		
		
	def describe_battery(self):
		"""Print a statement describing the battery size."""
		print("This " + self.make.title() + " has a " + str(self.battery_size) +
				"-KWh battery.")
